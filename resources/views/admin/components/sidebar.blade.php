            ...
            <div x-transition:enter="transform transition-transform duration-300"
                ...
                <nav x-show="currentSidebarTab == 'linksTab'" aria-label="Main" class="flex flex-col h-full">
                    ...
                    <ul class="flex-1 px-6 space-y-2 overflow-hidden hover:overflow-auto w-full">
                        ...
                        <li class="w-full hover:bg-pink-50 duration-150 py-2 hover:px-2 group"><a href="/admin/"
                                class="block w-full text-sm leading-5 font-normal no-underline text-gray-500 group-hover:text-[#FF6281] rounded-md">Users
                                manage</a>
                        </li>
                        <li class="w-full hover:bg-pink-50 duration-150 py-2 hover:px-2 group"><a
                                href="/admin/product"
                                class="block w-full text-sm leading-5 font-normal no-underline text-gray-500 group-hover:text-[#FF6281] rounded-md">Products
                                manage</a>
                        </li>
                        <li class="w-full hover:bg-pink-50 duration-150 py-2 hover:px-2 group"><a
                        ...
                        <li class="w-full hover:bg-pink-50 duration-150 py-2 hover:px-2 group"><a
                                href="/admin/game-manage"
                                class="block w-full text-sm leading-5 font-normal no-underline text-gray-500 group-hover:text-[#FF6281] rounded-md">Map
                                Manage</a>
                        </li>
                    </ul>
                </nav>
